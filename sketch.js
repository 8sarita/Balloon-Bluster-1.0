...
function setup() {
  ...
  //score =0
   ...
   getready=createSprite(width-180,height-300,50,50);
     ...
     li=createSprite(480,height-400,6,1000);
}
...
function draw() {
  ...
  strokeWeight(4 );
  fill("red");
  text("HIGHEST SCORE "+ highest,width-160,height-50);
 ...
 if(mousePressedOver(reset)|| touches.width=== width-180){
    r();
   ...
   rect(width-250,height-650,120,50);
   line(width-400,height-25,600,height-25);
   line(width-400,height-80,600,height-80);
  highest=[s];
  drawSprites();
...
function redBalloon() {
  var red = createSprite(width-380,Math.round(random(70, 370)), 10, 10);
...
function blueBalloon() {
  var blue = createSprite(width-380,Math.round(random(70, 370)), 10, 10);
...
function greenBalloon() {
  var green = createSprite(width-380,Math.round(random(70, 370)), 10, 10);
...
function pinkBalloon() {
  var pink = createSprite(width-380,Math.round(random(70, 370)), 10, 10);
...
function enemys() {
  var enemy = createSprite(width-380,Math.round(random(70, 370)), 10, 10);
